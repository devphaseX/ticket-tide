...
import { useLogout } from "@/features/api/mutations/use_logout";
import { useCurrentUser } from "@/features/api/query/get_current_user";
  ...
  if (isLoading) {
    return (
      <div
        ...
        justify-center bg-neutral-100 border border-neutral-300"
      >
    ...
    <DropdownMenu modal={false}>
      ...
      >
        ...
        <DropdownMenuItem
          ...
          text-amber-700 font-medium cursor-pointer"
        >
